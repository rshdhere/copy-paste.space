...
export function Sender(){
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#191A1A]">
            <div className="flex w-[36rem] mt-4 relative z-10">
                {/* Textarea container */}
                <div className="flex flex-col w-full bg-[#2A2A2A] rounded-lg shadow-lg overflow-hidden relative border border-neutral-600">
                    ...
                    <div className="absolute -top-2 left-4 right-4 z-20">
                        <div className="flex items-center gap-2 bg-[#2A2A2A]/90 backdrop-blur-sm border border-white/10 rounded-md px-3 py-2 shadow-lg">
                    ...
                    {/* Text input area */}
                    <div className="flex-4 p-4 pt-8 pb-2">
                        <textarea
...
public class Example {
    public static void main( String[] args ) {
        System.out.println("Example for sharing a Java-Program");
                    ...
                    <div className="flex items-center justify-between p-4 border-t border-white/10 bg-[#2A2A2A]">
                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <div className="flex items-center space-x-2 bg-transparent rounded-lg px-2 py-1.5 border border-gray-400/30 cursor-pointer hover:bg-white/5 transition-colors">
                                <span className="text-white text-sm font-mono">{code || "OTP"}</span>
                                <button 
                                    onClick={() => {
                                        if (code) {
