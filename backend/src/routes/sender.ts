...
// Handle data sent from frontend securely
// Protected (requires Access-key header)
senderRouter.post('/send', verifyFrontendAccess, (req, res) => {
    res.json({ message: 'Message received securely' });
});
